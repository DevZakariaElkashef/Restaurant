    ...
    <div id="content" class="main-content container ">
       <div class="row mt-5">
           <div class="col-md-9 mx-auto">
                <form action="{{ route('users.update', $row->id) }}" method="POST" id="editUser" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="password" class="form-control" name="password"  id="formGroupExampleInput2" placeholder="New Password ?">
                    </div>
