    ...
    <div id="content" class="main-content container ">
       <div class="row mt-5">
           <div class="col-md-9 mx-auto">
                <form action="{{ route('chefs.update', $row->id) }}" method="POST" id="editChef" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-group mb-4">
                        ...
                        <textarea name="chef_description" class="form-control" id="formGroupExampleInput2" cols="30" rows="5">{{ $row->chef_description }}</textarea>
                    </div>
